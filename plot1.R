...
hist(hh.sub$Global_active_power, main = "Global Active Power", xlab = "Global Active Power (kilowatts)", col = "red")

# Copy histogram to a png file. Pixel size default is 480 x 480.
